% 04/01/2016
% this work has been moved to Burst_CMD_Compensation folder
...
% % end
% %% ZC calibration sequences
% temp = lteZadoffChuSeq(31,6301);
% CAL(:,1) = lteZadoffChuSeq(31,6300);
% CAL(:,2) = lteZadoffChuSeq(41,6300);
% CAL(:,3) = lteZadoffChuSeq(51,6300);
% CAL(:,4) = lteZadoffChuSeq(61,6300);
% 
% %% tagging
% 
% CAL=zeros(P,N);
