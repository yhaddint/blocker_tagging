...
switch filecode
    case 1
        M = csvread('C:\Users\Han\Google Drive\Blocker Tagging\March 19th\01.csv');   % read data
    case 2
        M = csvread('C:\Users\Han\Google Drive\Blocker Tagging\March 19th\10.csv');   % read data
    case 3
        M = csvread('C:\Users\Han\Google Drive\Blocker Tagging\March 19th\11.csv');   % read data
end
%%
...
CFO = -3e3/1e6;                   % Heristic value of CFO b/w BLK and inserted PN%
time_true = [t(start_idx:watch_size);...
             t(1:start_idx-1)];   % Due to rearrange for cyclic capture
carrier_OS = cos(-0.1*pi + 2*pi * ( 5 + CFO ) * 1e6 * time_true );
